...
<footer class="site-footer">
  <div class="container">
      ...
      <div class="col-lg-4 col-md-12">
        <div class="footer-brand">
          ...
          <span class="footer-name">
            <span class="brand-patil">PATIL's</span><br>
            <span class="accent" style="font-size:0.95rem;">Construction & Interior's</span>
          </span>
        </div>
        <p class="footer-bio">
          Civil Engineer & Construction Specialist based in Gokak, Karnataka.
          Delivering 22+ quality building, interior &amp; government infrastructure projects.
        </p>
        <div class="footer-social">
          <a href="https://wa.me/918747061867" target="_blank" rel="noopener noreferrer"
             aria-label="Chat on WhatsApp" title="Chat on WhatsApp" class="social-icon">
            <i class="fab fa-whatsapp"></i>
          </a>
          <a href="https://www.instagram.com/blacck_heaart?igsh=bnRxc2FsZTZoYXIw"
             target="_blank" rel="noopener noreferrer" aria-label="Instagram"
             title="Follow on Instagram" class="social-icon">
      ...
      <div class="col-lg-4 col-sm-4 col-12">
        ...
        <ul class="footer-contact-list">
          <li>
            ...
            <a href="mailto:Patilpradeep754@gmail.com">Patilpradeep754@gmail.com</a>
          </li>
          <li>
            <i class="fas fa-phone"></i>
            <a href="tel:+918747061867">+91 8747061867</a>
          </li>
          <li>
    ...
    <div class="footer-bottom">
      <p class="mb-0">
        &copy; <?= date('Y') ?>
        <span class="brand-patil" style="font-size:0.9em;font-weight:400;color:inherit;font-style:italic;">PATIL's</span>
        construction &amp; interior's. All rights reserved.
        Built with <i class="fas fa-heart accent-text"></i> for construction excellence.
      </p>
    </div>
